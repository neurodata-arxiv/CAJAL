function cubeCutoutPreprocessAdvanced(serverLocation, token, channel, resolution, ...
    ...
    %                       Revision History
    % Author            Date                Comment
    % D.Kleissas    11-Mar-2014             Initial Release
    % J.Matelsky    25-Aug-2015             Add channels
    %
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        for zz = 1:numZblocks
            for yy = 1:numYblocks
                for xx = 1:numXblocks
                    ...
                    % Save query
                    tFilename = fullfile(cubeOutputDir,sprintf('ccQuery_%s_r%d_x%d-%d_y%d-%d_z%d-%d.mat',...
                        token,...
                        channel,...
                        resolution,...
                        xMin, xMax,...
        ...
        for ee = 1:length(zEdges)
            ...
            for yy = 1:numYblocks
                for xx = 1:numXblocks
                    ...
                    % Save query
                    tFilename = fullfile(mergeOutputDir,sprintf('mergeQuery_%s_r%d_x%d-%d_y%d-%d_z%d-%d.mat',...
                        token,...
                        channel,...
                        resolution,...
                        xMin, xMax,...
